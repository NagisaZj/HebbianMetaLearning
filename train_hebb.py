...
def main(argv):
    ...
    parser.add_argument('--generations', type=int, default= 3000, metavar='', help='Number of generations that the ES will run.')
    parser.add_argument('--threads', type=int, metavar='', default = 10, help='Number of threads used to run evolution in parallel: -1 uses all threads available')
